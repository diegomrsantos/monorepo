...
![Throughput ratios across the primary matrix](results/native/throughput-grid.png)
...
[The full tables](results/native/TABLES.md) include baseline rates, CPU costs,
...
See [the protocol](BACKEND_PROTOCOL.md) for commands and
[the evidence inventory](results/native/ARTIFACTS.md) for the retained records.
